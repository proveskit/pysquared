...
class XYSolarPanelManager(SolarPanelProto, LoadSwitchProto):
    ...
    def get_temperature(self) -> float | None:
        ...
        if not self._load_enabled:
            raise NotPowered("XY solar panel is not powered")
        ...
        try:
            ...
            self._log.error("Failed to read XY solar panel temperature", err=e)
            return None
    ...
    def get_light_level(self) -> float | None:
        ...
        try:
            ...
            self._error_count += 1
            self._last_error = str(e)
            self._log.error("Failed to read XY solar panel light level", err=e)
            return None
    ...
    def drive_torque_coils(self, **kwargs) -> bool:
        ...
        if self._torque_coils is None:
            raise NotImplementedError("Torque coils not available for XY solar panel")
        ...
        try:
            ...
            self._error_count += 1
            self._last_error = str(e)
            self._log.error("Failed to drive XY solar panel torque coils", err=e)
            return False
    ...
    def enable_load(self) -> bool:
        ...
        if self._load_switch_pin is None:
            raise NotImplementedError("Load switch pin is required for XY solar panel")
        ...
        try:
            ...
            self._log.error("Failed to enable XY solar panel load switch", err=e)
            return False
    ...
    def disable_load(self) -> bool:
        ...
        try:
            ...
            self._log.error("Failed to disable XY solar panel load switch", err=e)
            return False
    ...
    def reset_load(self) -> bool:
        ...
        try:
            ...
            self._log.error("Failed to reset XY solar panel load switch", err=e)
            return False
