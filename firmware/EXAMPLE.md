...
Fetching CircuitPython submodules (raspberrypi port only)...
Installing CircuitPython build dependencies...
...
python3 tools/ci_fetch_deps.py raspberrypi  # Re-fetch if needed
```
